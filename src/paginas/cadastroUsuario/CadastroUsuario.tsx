...
function CadastroUsuario() {
    ...
    async function onSubmit(e: ChangeEvent<HTMLFormElement>) {
        ...
        toast.success ('Usuário Cadastrado Com Sucesso - SEJA BEM VINDO :) !', { //definições do alerta
            position: "top-right",
            autoClose: 2000,
            ...
            toast.error ('Dados Inconsistentes. Favor verificar as informações de cadastro.', { //definições do alerta
                position: "top-right",
                autoClose: 2000,
                hideProgressBar: false,
                closeOnClick: true,
                    ...
                    <form  onSubmit={onSubmit}>
                        ...
                        <Box marginTop={2} textAlign='center'>
                            <Link to='/login' className='text-decorator-none'>
                                <Button variant='contained' className='botaoCancela'>
                                    Cancelar
                                </Button>
                            </Link>
